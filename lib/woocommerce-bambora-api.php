<?php
/*
* Plugin Name: WooCommerce Bambora Payment Gateway
* Plugin URI: http://www.bambora.com/
* Description: Process credit card payments easily on your store using Bambora.
...
/**
 * WooCommerce Bambora API
 */

class WooCommerce_Bambora_Api extends SoapClient {
