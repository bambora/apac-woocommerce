...
class Bambora_Apac extends WC_Payment_Gateway_CC {
		...
		if($this->checkout_mode=='api'){	
			...
			if($this->save_card_detail=='yes'){
				...
				if(isset($_POST['wc-bambora_apac-payment-token']) && trim($_POST['wc-bambora_apac-payment-token'])!='new'){
					$token_id = trim($_POST['wc-bambora_apac-payment-token']);
	...
	function bp_metabox_callback( $post ) { 
		...
		<input class="widefat" id="Amount" type="text" name="Amount" maxlength="150" required placeholder="<?php _e( 'Amount', 'bambora-apac' ); ?>" value="<?php echo  $Amount ; ?>" />
		</p>
		...
		<input class="widefat" id="EndPaymentCount" type="text" name="EndPaymentCount" maxlength="10" placeholder="<?php _e( 'End Payment Count', 'bambora-apac' ); ?>" value="<?php echo  $EndPaymentCount ; ?>" />
		</p>

		<p>
		<label for="ScheduleID"><?php _e( 'Schedule ID', 'bambora-apac' ); ?></label> 
		<input class="widefat" id="ScheduleID" type="text" name="ScheduleID" maxlength="15" placeholder="<?php _e( 'Schedule ID', 'bambora-apac' ); ?>" value="<?php echo  $ScheduleID ; ?>" />
		</p>
	...
	function bb_metabox_callback( $post ) { 
		...
		<input class="widefat" id="BatchID" type="text" name="BatchID" maxlength="150" required placeholder="<?php _e( 'Batch ID', 'bambora-apac' ); ?>" value="<?php echo  $BatchID ; ?>" />
		</p>
		...
		<input class="widefat" id="Totaltransactions" type="text" name="Totaltransactions" maxlength="10" placeholder="<?php _e( 'Total Transactions', 'bambora-apac' ); ?>" value="<?php echo  $Totaltransactions ; ?>" />
		</p>

		<p>
		<label for="Totalamount"><?php _e( 'Total Amount', 'bambora-apac' ); ?></label> 
		<input class="widefat" id="Totalamount" type="text" name="Totalamount" maxlength="10" placeholder="<?php _e( 'Total Amount', 'bambora-apac' ); ?>" value="<?php echo  $Totalamount ; ?>" />
		</p>
